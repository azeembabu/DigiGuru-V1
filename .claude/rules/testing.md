...
| NN-3 quota | Cap fires at 3600 s of active voice with a skewed client clock; the ledger resets at midnight in the student's own timezone, not UTC; a session spanning that boundary is charged to the correct day |
